...
<body>
  ...
  <h2 style="text-align: center">Registro <?php echo strtoupper($_SESSION["user"]); ?></h2>
  ...
  <form id="xx" >
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-5">
        <input type="text" class="form-control "name="h_fin" id="h_fin" placeholder="Hora de Termino">
      </div>
    </div>
    <?php foreach ($data as $key => $value) {
      if ($value!=null ){
        ...
        if (in_array($key,$xarr) ) {
          ...
          $aux="vocal Organizacion suplente";
      ...
      echo'<div class="form-group row bg-danger">
  ...
  <?php while ($fila=mysqli_fetch_row($resultado)) {//<div class="col-sm-1 col-form-label" > <a href="archivos/hojas.pdf" download class="btn btn-default" ><span class="fa fa-file-pdf-o"style="font-size:24px" aria-hidden="true"></span></a></div>
    echo '<div class="form-group row  bg-danger">';
    if ($fila[2]==null) {
...
if ($fila[1]=="independiente1"||$fila[1]=="independiente2"||$fila[1]=="independiente3") {
     echo'<div class="col-sm-1 col-form-label">  <img  src="logos/'.$fila[8].'.png" WIDTH="40" HEIGHT="40"></div>';
}else{   echo'<div class="col-sm-1 col-form-label">  <img  src="logos/'.$fila[1].'.png" WIDTH="40" HEIGHT="40"></div>';}

    echo'<div class="form-group">
          <label  class="col-sm-4 col-form-label "id="'.$fila[1].'titularn" >P: '.strtoupper($fila[5]).'</label>
          <button  type="button" class="btn btn-primary" onclick="mostrardos('."'".$fila[0]."','".$fila[1]."titular'".','."'".'titular'."'".');" >
            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
          </button>

          <div class="col-sm-1">
            <input type="checkbox" class="form-check-input" name="'.$fila[1].'titular" id="'.$fila[1].'titular" >
          </div>
       ...
       <div class="form-line">
         ...
         <div class="col-sm-4"></div>
          <label  class="col-sm-4 col-form-label "id="'.$fila[1].'suplenten" >S: '.strtoupper($fila[6]).'</label>
          <button  type="button" class="btn btn-primary" onclick="mostrardos('."'".$fila[0]."','".$fila[1]."suplente'".','."'".'suplente'."'".');" >
            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
          </button>

          <div class="col-sm-1">
            <input type="checkbox" class="form-check-input" name="'.$fila[1].'suplente" id="'.$fila[1].'suplente" >
          </div>
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form enctype="multipart/form-data" id="modarchivo" method="post" action="service/editpr.php">
              ...
              <input  accept=".pdf" type="file"  id="archi_file" name="archi_file"/><br>
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form enctype="multipart/form-data" id="certarchivo" method="post" action="service/subcert.php">
              ...
              <input  accept=".pdf" type="file"  id="cert_file" name="cert_file"/><br>
